import unittest
from scrapper.scrapper import Get_news
...
class TestScrapper(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_news_elements_1 = news.get_elements("https://www.tehrantimes.com/news/451525/A-glimpse-of-Muharram-mourning-rituals-across-Iran-Bil-Zani")
        self.test_news_elements_2 = news.get_elements("https://www.tehrantimes.com/news/451659/Energy-efficient-households-to-get-100-discount-on-electricity")
        self.test_news_elements_3 = news.get_elements("https://www.tehrantimes.com/news/451604/Incentive-packages-help-energy-ministry-pass-summer-without-blackouts")
